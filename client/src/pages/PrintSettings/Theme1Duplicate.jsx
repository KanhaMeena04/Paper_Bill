...
const Theme1Duplicate = ({ invoiceData, isEditable }) => {
  return (
    <div className="w-full max-w-2xl mx-auto border-b border-gray-300 bg-white shadow-md rounded-lg p-4 font-sans text-gray-700 text-sm">
      <div className="text-end">
        <h1 className="text-sm">{invoiceData.printDuplicateLabel}</h1>
      </div>
...
export default Theme1Duplicate;
