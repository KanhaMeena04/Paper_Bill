...
const Theme2Base = ({ invoiceData, isEditable }) => {
  return (
        ...
        <div className="mt-4 space-y-2">
          ...
          {invoiceData?.youSavedChecked && (
            <p className="text-sm font-bold">
              You Saved: AED {invoiceData?.summary.subTotal}
            </p>
          )}
        </div>
